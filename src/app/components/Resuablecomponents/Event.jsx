...
function Event(props) {
                            ...
                            <div>
                                <a className="event_item__wrapper" draggable="false">
                                    ...
                                    <Image
                                        ...
                                        }} layout='responsive' width={item.width}
                                        height={item.height}
                                    />
                                    <Image
                                        src={item.tabimage}
                                        className="xl:hidden sm:block hidden rounded-xl  max-w-[100%]  h-auto"
                                        style={{ filter: "brightness(0.9)" }} layout='responsive' width={item.width}
                                        height={item.height}
                                    />
                                    <Image
                                        src={item.lagmobdevice}
    ...
    text-2xl"
            ...
            {/* <a className="button max-w-xs mt-5" style={{ marginTop: "20px" }} href="/events">
                explore more
            </a> */}
        </section>
    )
